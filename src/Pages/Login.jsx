...
function Login() {
  ...
  const { login, isAdmin, ADMIN_EMAIL } = useAuth()
      ...
      >
        ...
        >
          ...
          <p className="text-xs opacity-75 mt-1">
            Admins can manage properties and access the admin dashboard
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {formData.email === ADMIN_EMAIL && (
                <p className="mt-1 text-sm text-purple-600 dark:text-purple-400 font-medium flex items-center">
